...
export class LandmarksFixture extends PageFixture {
    ...
    //#region Wizard Selectors

    public $wizardHeading = this.page.getByTestId("wizard-heading");
    public $wizardNavigationNext = this.page.getByTestId("wizard-navigation-next");
    public $wizardNavigationAbort = this.page.getByTestId("wizard-navigation-abort");
    public $wizardNavigationCancel = this.page.getByTestId("wizard-navigation-cancel");
